...
module.exports = {
    name: 'boobs',
    description: 'Sends a random NSFW GIF of boobs',
    async execute(message, args, client, prefix, db) {
        try {
            ...
            const apiUrl = 'https://nekobot.xyz/api/image?type=boobs'; // Nekobot API for random NSFW boob GIF.
            ...
            if (imageUrl) {
                const embed = new EmbedBuilder()
                    .setTitle('Here\'s a random NSFW GIF of boobs')
                    .setImage(imageUrl)
                    .setColor('#FF69B4');
