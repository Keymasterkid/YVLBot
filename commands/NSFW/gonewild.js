...
module.exports = {
    name: 'gonewild',
    description: 'Sends a random NSFW GIF from the Gonewild category',
    async execute(message, args, client, prefix, db) {
        try {
            ...
            const apiUrl = 'https://nekobot.xyz/api/image?type=gonewild'; // Nekobot API for Gonewild NSFW GIF.
            ...
            if (imageUrl) {
                const embed = new EmbedBuilder()
                    .setTitle('Here\'s a random NSFW GIF from Gonewild')
                    .setImage(imageUrl)
                    .setColor('#FF69B4');
