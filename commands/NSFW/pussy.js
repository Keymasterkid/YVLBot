...
module.exports = {
    name: 'pussy',
    description: 'Sends a random NSFW GIF of pussy',
    async execute(message, args, client, prefix, db) {
        try {
            ...
            const apiUrl = 'https://nekobot.xyz/api/image?type=pussy'; // Nekobot API for random NSFW pussy GIF.
            ...
            if (imageUrl) {
                const embed = new EmbedBuilder()
                    .setTitle('Here\'s a random NSFW GIF of pussy')
                    .setImage(imageUrl)
                    .setColor('#FF69B4');
