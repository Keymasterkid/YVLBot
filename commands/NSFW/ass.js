...
module.exports = {
    name: 'ass',
    description: 'Sends a random NSFW GIF of ass',
    async execute(message, args, client, prefix, db) {
        try {
            ...
            const apiUrl = 'https://nekobot.xyz/api/image?type=ass'; // Nekobot API for random NSFW ass GIF.
            ...
            if (imageUrl) {
                const embed = new EmbedBuilder()
                    .setTitle('Here\'s a random NSFW GIF of ass')
                    .setImage(imageUrl)
                    .setColor('#FF69B4');
